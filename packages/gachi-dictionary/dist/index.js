// src/gachi-dictionary.json
var gachi_dictionary_default = {
  keywords: {
    const: "tight",
    let: "flexible",
    var: "loose",
  ...
  types: {
    ...
    WeakMap: "weak_dictionary",
    WeakSet: "weak_collection"
  },
  methods: {
    push: "insert",
    pop: "extract",
  ...
  framework_specific: {
    react: {
      useState: "manageTightness",
      useEffect: "onDomination",
      useContext: "useEnvironment",
      useReducer: "manageComplexTightness",
      useMemo: "remember",
      useCallback: "memorizePerformance",
      useRef: "reference",
      Component: "DungeonMaster",
      PureComponent: "PureDungeonMaster",
      render: "manifest",
      props: "gifts",
      state: "condition",
      setState: "adjustCondition",
      componentDidMount: "onMounting",
      componentWillUnmount: "beforeDestruction",
      JSX: "GachiML"
    },
    angular: {
      "@Component": "@DungeonRoom",
      "@Injectable": "@Summonable",
      "@Input": "@Receive",
      "@Output": "@Emit",
      "@ViewChild": "@SpotChild",
      OnInit: "OnAwakening",
      OnDestroy: "OnDestruction",
      ngOnInit: "awaken",
      ngOnDestroy: "destroy",
      constructor: "birth",
      service: "servant",
  ...
  phrases: {
    ...
    comments: {
      single_line: "// DEEP DARK COMMENT",
      multi_line_start: "/* FISTING IS 300 BUCKS",
      multi_line_end: "RIGHT VERSION! */"
    }
  },
  special_constructs: {
    arrow_function: "=>",
    ...
    rest_parameter: "remaining",
    default_parameter: "fallback_gift",
    generator: "endless_performance",
    iterator: "stepper",
    proxy: "representative",
    reflect: "mirror",
    symbol_iterator: "iteration_token",
    async_iterator: "delayed_stepper"
  },
  builtin_objects: {
    console: "logger",
    window: "browser_dungeon",
    document: "page_structure",
    localStorage: "permanent_storage",
    sessionStorage: "temporary_storage",
    JSON: "serializer",
    Math: "calculator",
    Array: "Collection",
    Object: "Structure",
...
// src/index.ts
var GachiTransformer = class {
  dictionary;
  reverseDictionary;
  constructor() {
    this.dictionary = gachi_dictionary_default;
  ...
  jsToGachi(keyword, options) {
    ...
    return this.dictionary.keywords[keyword] || this.dictionary.operators[keyword] || this.dictionary.types[keyword] || this.dictionary.methods[keyword] || this.dictionary.builtin_objects[keyword] || this.dictionary.special_constructs[keyword] || keyword;
  }
  /**
   * Transform GachiScript keywords to JavaScript/TypeScript
   */
  gachiToJs(gachiKeyword) {
   ...
   */
  transformExpression(expression, toGachi = true, options) {
    if (toGachi) {
  ...
  transformToGachi(expression, options) {
  ...
  getSuggestions(keyword) {
    ...
    for (const gachiKeyword of this.reverseDictionary.keys()) {
      if (gachiKeyword.toLowerCase().includes(lowerKeyword) || lowerKeyword.includes(gachiKeyword.toLowerCase())) {
...
var gachiTransformer = new GachiTransformer();
var dictionary = gachi_dictionary_default;
var {
  keywords,
  operators,
  types,
